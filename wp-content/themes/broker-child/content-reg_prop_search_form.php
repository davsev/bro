<form class="search-slide" action="<?php echo home_url('/advanced-property-search/'); ?>" method="get" id="reg-prop-searchform">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    ?>
                                    <input type="text" class="form-control" placeholder="עיר" name="field_59ae96d970a06" id="prop-city" data-toggle="tooltip" data-placement="auto" title="יש להזין לפחות שלושה תווים">
                                    </div>
                                </div>
                                    <!--  / ישוב -->
                                    <!-- סוג הנכס -->
