<?php
/**
 * Template Name: Advanced property page
 */
/**
 * http://127.0.0.1/brok/חיפשו-נכסים-מתקדם/?field_59ae96d970a06&front-prop-search=%D7%91%D7%93%D7%99%D7%A7%D7%94#038;front-prop-search=%D7%91%D7%93%D7%99%D7%A7%D7%94
 */
...
<div class="col-xs-12">
        <header>
            <h2 class="page-title"><?php printf( __( 'תוצאות חיפוש: %s', '_tk' ), '<span></span>' ); ?></h2>
        </header><!-- .page-header -->
    <p><?php
    // if($area=='' && $city=='')
    // {
    ...
    // };
        ...
        <?php if( $the_query->have_posts() ): ?>
            <?php while( $the_query->have_posts() ) : $the_query->the_post(); ?>
                ...
                <?php get_template_part( 'content', 'prop_preview' ); ?>
