...
<div class="col-md-5" id="broker-form"><?php echo do_shortcode('[contact-form-7 id="370" title="broker cf"]'); ?></div>
    ...
    <!-- Modal facebook-->
  <div class="modal fade" id="facebook-modal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">דף פייסבוק</h4>
        </div>
        <div class="modal-body">
          <iframe width="560" height="315" src="<?php echo get_user_meta( $user_id, 'pie_text_29', true ); ?>" frameborder="0" allowfullscreen></iframe>
        </div>
