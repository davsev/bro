<script type="text/template" id="yrc-main-tmpl">
	...
	<div id="pbc-feedback">
		...
		<a class="button" href="http://plugin.builders/yourchannel/docs" target="_blank"><?php _e('Docs & Troubleshooting', 'YourChannel'); ?></a>
	</div>
	<div id="yrc-do-upgrade">
		...
		<a class="button button-primary" target="_blank" href="http://plugin.builders/yourchannel/?from=wp&v=<?php echo WPB_YourChannel::$version; ?>">Upgrade</a>
	...
	<form class="pbc-pane" id="pbc-form">
		<div class="pbc-row">
			...
			<div class="pbc-row-field wpb-inline">
				...
				<p style="margin:.25em 0">Test with the default API Key, then please create your own API key by following <a href="http://plugin.builders/yourchannel-setup/" target="_blank">instructions here,</a> not doing so might show just <strong>Loading...</strong></p>
			</div>
		</div>
		...
		<div class="pbc-row">
			...
			<div class="pbc-row-field wpb-inline">
				<a class="button pbc-field-toggler" id="style-options-toggler"><?php _e('Show Options', 'YourChannel'); ?></a>
				<div class="pbc-togglable-field wpb-force-hide" id="pbc-style-field">	
					...
					<div class="pbc-row yrc-theme" data-theme="<%= theme %>">
						...
						<div class="pbc-row-field wpb-inline">
							...
							<div class="pbc-row yrc-only-pro">
							...
							<div class="pbc-field wpb-inline" data-show="['__grid', '__carousel', '__list']">
					...
					<div class="pbc-row">
						...
						<div class="pbc-row-field wpb-inline" id="yrc-player-options">
							...
							<div class="pbc-field wpb-inline">
								<label><input type="radio" name="player_mode" value="3" class="wpb-raw" <%- (parseInt(style.player_mode) === 3) ? 'checked' : ''  %>/><?php _e('On Top', 'YourChannel'); ?></label>
							</div>
