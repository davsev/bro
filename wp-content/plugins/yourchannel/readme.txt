...
= 0.9.2 =
* New default API Key.
* Fixed a bug that didn't show videos when the container was hidden on page load.

= 0.9 =
* Implemented cache system to load faster and make less YouTube API calls.
* Added a new List theme.
* Shortcode to embed single videos: `[yourchannel video="C8WOH3eoCMw"]`.
