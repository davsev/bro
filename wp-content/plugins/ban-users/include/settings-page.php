        ...
        <div class="w3dev-tab active" id="tab-options">
            ...
            <form style="padding-top: 15px;">
                ...
                <div id="w3dev-accessibility-section" class="w3dev-settings-section">
                    <h3><i class="w3dev-icon fa fa-2x fa-low-vision" aria-hidden="true"></i><?php _e('Accessibility Options', 'ban-users'); ?><a class="w3dev-toggle-content" style="float:right"><i class="fa fa-caret-down" aria-hidden="true"></i></a></h3>
               ...
               <div id="w3dev-general-section" class="w3dev-settings-section">
                    <h3><i class="w3dev-icon fa fa-2x fa-cog" aria-hidden="true"></i><?php _e('General Options', 'ban-users'); ?><a class="w3dev-toggle-content" style="float:right"><i class="fa fa-caret-down" aria-hidden="true"></i></a></h3>
                ...
                <div id="w3dev-ban-options-section" class="w3dev-settings-section">
                    <h3><i class="w3dev-icon fa fa-2x fa-ban" aria-hidden="true"></i><?php _e('Ban &amp; Unban Options', 'ban-users'); ?><a class="w3dev-toggle-content" style="float:right"><i class="fa fa-caret-down" aria-hidden="true"></i></a></h3>
               ...
               <div id="w3dev-default-messages-section" class="w3dev-settings-section">
                    <h3><i class="w3dev-icon fa fa-2x fa-bullhorn" aria-hidden="true"></i><?php _e('Default Messages', 'ban-users'); ?><a class="w3dev-toggle-content" style="float:right"><i class="fa fa-caret-down" aria-hidden="true"></i></a></h3>
                    ...
                    <div id="js-default-ban-reason" class="mb-10" style="<?php echo (empty($settings['ban_email_default'] )) ? 'display:none;' : null; ?>">
                        <label style="margin-bottom:5px;display:block;"><?php _e("Default 'reason' for banning a user:", 'ban-users'); ?> <span style="position: relative;top:-1px;" class="bs-label label-success"><?php _e('NEW', 'ban-users'); ?></span><br />
                    ...
                    <div id="js-default-warn-reason" class="mb-10" style="<?php echo (empty($settings['warn_user'] )) ? 'display:none;' : null; ?>">
                        <label style="margin-bottom:5px;display:block;"><?php _e("Default 'reason' for warning a user:", 'ban-users'); ?> <span style="position: relative;top:-1px;" class="bs-label label-success"><?php _e('NEW', 'ban-users'); ?></span><br />
                ...
                <div id="w3dev-ipgeo-section" class="w3dev-settings-section">
                    <h3><i class="w3dev-icon fa fa-2x fa-map-marker" aria-hidden="true"></i><?php _e('IP/Geodata Options', 'ban-users'); echo ' <span style="color:#d8534f">'; _e('(Premium Feature)', 'ban-users'); ?></span><a class="w3dev-toggle-content" style="float:right"><i class="fa fa-caret-down" aria-hidden="true"></i></a></h3>
                ...
                <div id="w3dev-notification-section" class="w3dev-settings-section">
                    <h3><i class="w3dev-icon fa fa-2x fa-flag" aria-hidden="true"></i><?php _e('Notification Options', 'ban-users'); echo ' <span style="color:#d8534f">'; _e('(Premium Feature)', 'ban-users'); ?></span><a class="w3dev-toggle-content" style="float:right"><i class="fa fa-caret-down" aria-hidden="true"></i></a></h3>
                ...
                <div id="w3dev-users-table-section" class="w3dev-settings-section">
                    <h3><i class="w3dev-icon fa fa-2x fa-table" aria-hidden="true"></i><?php _e('Users Table Options', 'ban-users'); ?><a class="w3dev-toggle-content" style="float:right"><i class="fa fa-caret-down" aria-hidden="true"></i></a></h3>
                ...
                <div id="w3dev-warn-options-section" class="w3dev-settings-section">
                    <h3><i class="w3dev-icon fa fa-2x fa-exclamation-triangle" aria-hidden="true"></i><?php _e('Warn Options', 'ban-users'); ?><a class="w3dev-toggle-content" style="float:right"><i class="fa fa-caret-down" aria-hidden="true"></i></a></h3>
                ...
                <div id="w3dev-security-section" class="w3dev-settings-section">
                    <h3><i class="w3dev-icon fa fa-2x fa-shield" aria-hidden="true"></i><?php _e('Security Settings', 'ban-users'); ?><a class="w3dev-toggle-content" style="float:right"><i class="fa fa-caret-down" aria-hidden="true"></i></a></h3>
                ...
                <div id="w3dev-3rdparty-section" class="w3dev-settings-section">
                    <h3><i class="w3dev-icon fa fa-2x fa-plug" aria-hidden="true"></i><?php _e('3rd Party Plugin Support', 'ban-users'); ?><a class="w3dev-toggle-content" style="float:right"><i class="fa fa-caret-down" aria-hidden="true"></i></a></h3>
               ...
               <div id="w3dev-shortcodes-section" class="w3dev-settings-section">
                    <h3><i class="w3dev-icon fa fa-2x fa-wordpress" aria-hidden="true"></i><?php _e('Plugin Shortcodes', 'ban-users'); ?><a class="w3dev-toggle-content" style="float:right"><i class="fa fa-caret-down" aria-hidden="true"></i></a></h3>
                ...
                <div id="w3dev-conflict-section" class="w3dev-settings-section">
                    <h3><i class="w3dev-icon fa fa-2x fa-bug" aria-hidden="true"></i><?php _e('Conflict Management', 'ban-users'); ?><a class="w3dev-toggle-content" style="float:right"><i class="fa fa-caret-down" aria-hidden="true"></i></a></h3>
...
-->
        ...
        <div class="w3dev-tab hidden" id="tab-email-template">
            ...
            <div style="margin-top: 15px;" class="w3dev-settings-section">
                <h3><i class="w3dev-icon fa fa-2x fa-cog" aria-hidden="true"></i><?php _e('Email Options:', 'ban-users'); ?><a class="w3dev-toggle-content" style="float:right"><i class="fa fa-caret-down" aria-hidden="true"></i></a></h3>
            ...
            <div style="margin-top: 15px;" class="w3dev-settings-section">
                ...
                <h3><i class="w3dev-icon fa fa-2x fa-code" aria-hidden="true"></i><?php _e('BAN User email template:', 'ban-users'); ?><a class="w3dev-toggle-content" style="float:right"><i class="fa fa-caret-down" aria-hidden="true"></i></a></h3>
                <div class="w3dev-content">
